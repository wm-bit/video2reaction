...
class VisualErase(nn.Module):
    def __init__(self,
        ...
        super(VisualErase, self).__init__()
    ...
    def forward(self, input: torch.Tensor):
        ...
        output = torch.mul(output, torch.unsqueeze(At, dim=1).repeat(1, 2048, 1))
...
class VisualEraseVivit(nn.Module):
    def __init__(self,
                 snippet_duration,
                 sample_size,
                 n_classes,
