...
def get_args():
    ...
    parser.add_argument('--d_vout', type=int, default=256,
                        help='output size in visual rnn')
    parser.add_argument('--d_aout', type=int, default=256,
                        help='output size in acoustic rnn')
    parser.add_argument('--d_tout', type=int, default=256,
                        help='output size in visual rnn')
    ...
    parser.add_argument('--d_prjh', type=int, default=512,
                        help='hidden size in projection network')
